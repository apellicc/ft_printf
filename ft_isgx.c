...
static void	ft_is_gx4(t_en *e, long long int *nb, char *tmp)
{
...
static void	ft_is_gx3(t_en *e, long long int *nb, int *test)
{
...
static void	ft_is_gx2(t_en *e, long long int *nb, char **tmp)
{
